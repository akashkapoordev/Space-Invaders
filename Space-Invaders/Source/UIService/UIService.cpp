...
namespace UI
{
	...
	UIService::UIService()
	{
		...
		instruction_controller = nullptr;
	...
	void UIService::createControllers()
	{
		...
		instruction_controller = new InstructionUIController();
	}
	...
	void UIService::initializeControllers()
	{
		...
		instruction_controller->initialize();
	}
